...
def main() -> None:
    ...
    parser.add_argument(
        "--out", default=None, help="Output PNG path. Defaults to <hdf5_dir>/zspec_vs_znss.png."
    )
    parser.add_argument("--dpi", type=int, default=150)
    parser.add_argument(
        "--zmax", type=float, default=None, help="Upper limit for z axes. Auto if not set."
    )
    ...
    for flag in flag_order:
        ...
        print(
            f"{flag:8s} {m.sum():>5d}  {nmad(dz[m]):>7.4f}  "
    ...
    for flag in flag_order:
        ...
        ax.errorbar(
            ...
            fmt=flag_marker[flag],
            ms=3,
            color=flag_colors[flag],
            ecolor=flag_colors[flag],
            elinewidth=0.5,
            capsize=0,
            lw=0,
            alpha=0.7,
